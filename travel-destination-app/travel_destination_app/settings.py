"""
Django settings for travel_destination_app project.
...
INSTALLED_APPS = [
    ...
    'destinations',  # Add your app here
]
...
ROOT_URLCONF = 'travel_destination_app.urls'
...
WSGI_APPLICATION = 'travel_destination_app.wsgi.application'
